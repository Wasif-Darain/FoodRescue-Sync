...
final mockListings = [
  Listing(id: 1, donorId: 1, donorName: 'Green Kitchen Restaurant', title: 'Chicken Biryani (30 servings)', description: "Freshly cooked biryani from today's event. Best consumed today.", price: 0, quantity: 30, listingType: ListingType.donation, pickupStart: DateTime.now().add(const Duration(hours: 1)), pickupEnd: DateTime.now().add(const Duration(hours: 4)), latitude: 23.8103, longitude: 90.4125, status: ListingStatus.active, category: 'Cooked Meals', distance: 1.2),
  Listing(id: 2, donorId: 2, donorName: 'Dhaka Bakery House', title: 'Bread Loaves Bundle', description: 'End-of-day bread at 60% off. Pick up before closing.', price: 80, quantity: 15, listingType: ListingType.flashSale, pickupStart: DateTime.now().add(const Duration(hours: 2)), pickupEnd: DateTime.now().add(const Duration(hours: 5)), latitude: 23.815, longitude: 90.42, status: ListingStatus.active, category: 'Bakery', distance: 2.5),
  ...
  Listing(id: 4, donorId: 4, donorName: 'Honest Grocery', title: 'Mixed Dairy Products', description: 'Milk, yogurt, and paneer nearing expiry. 50% off.', price: 150, quantity: 25, listingType: ListingType.flashSale, pickupStart: DateTime.now().add(const Duration(hours: 1)), pickupEnd: DateTime.now().add(const Duration(hours: 2)), latitude: 23.808, longitude: 90.418, status: ListingStatus.active, category: 'Dairy', distance: 3.1),
  Listing(id: 5, donorId: 5, donorName: 'Bismillah Catering', title: 'Roti & Dal Set', description: '60 rotis with dal – surplus from wedding catering today.', price: 0, quantity: 60, listingType: ListingType.donation, pickupStart: DateTime.now().add(const Duration(hours: 4)), pickupEnd: DateTime.now().add(const Duration(hours: 10)), latitude: 23.825, longitude: 90.41, status: ListingStatus.active, category: 'Bakery', distance: 4.0),
  Listing(id: 6, donorId: 1, donorName: 'Green Kitchen Restaurant', title: 'Fish Curry (18 servings)', description: 'Leftover fish curry from lunch service.', price: 0, quantity: 18, listingType: ListingType.donation, pickupStart: DateTime.now().subtract(const Duration(hours: 3)), pickupEnd: DateTime.now().subtract(const Duration(hours: 1)), latitude: 23.8103, longitude: 90.4125, status: ListingStatus.active, category: 'Cooked Meals', distance: 1.5),
  Listing(id: 7, donorId: 2, donorName: 'Dhaka Bakery House', title: 'Pastry Assortment', description: 'Assorted pastries from this morning.', price: 60, quantity: 20, listingType: ListingType.flashSale, pickupStart: DateTime.now().subtract(const Duration(hours: 5)), pickupEnd: DateTime.now().subtract(const Duration(hours: 2)), latitude: 23.815, longitude: 90.42, status: ListingStatus.active, category: 'Bakery', distance: 2.8),
];
...
final mockAccounts = [
  RegisteredAccount(id: 1, name: 'Green Kitchen Restaurant', email: 'contact@greenkitchen.com', accountType: AccountType.restaurant, mode: UserMode.donor, status: AccountStatus.approved, joinedAt: DateTime(2026, 5, 12), listingsCreated: 45, kgSaved: 320, fulfillmentRate: 92, rating: 4.3, reviewCount: 6),
  RegisteredAccount(id: 2, name: 'Dhaka Bakery House', email: 'info@dhakabakery.com', accountType: AccountType.store, mode: UserMode.donor, status: AccountStatus.approved, joinedAt: DateTime(2026, 5, 20), listingsCreated: 8, kgSaved: 40, fulfillmentRate: 85, rating: 3.9, reviewCount: 4),
  RegisteredAccount(id: 3, name: 'Star Caterers', email: 'hello@starcaterers.com', accountType: AccountType.caterer, mode: UserMode.donor, status: AccountStatus.pending, joinedAt: DateTime(2026, 6, 25), listingsCreated: 2, kgSaved: 10, fulfillmentRate: 75),
  RegisteredAccount(id: 4, name: 'Dhaka Food Bank', email: 'admin@dhakafoodbank.org', accountType: AccountType.foodBank, mode: UserMode.consumer, status: AccountStatus.approved, joinedAt: DateTime(2026, 4, 3), isAvailable: true, mealsRescued: 65, onTimePickupRate: 96, rating: 4.6, reviewCount: 12),
  RegisteredAccount(id: 5, name: 'Hunger Help BD', email: 'contact@hungerhelp.bd', accountType: AccountType.ngo, mode: UserMode.consumer, status: AccountStatus.approved, joinedAt: DateTime(2026, 4, 15), isAvailable: false, mealsRescued: 12, onTimePickupRate: 88, rating: 3.9, reviewCount: 4),
  RegisteredAccount(id: 6, name: 'Al-Amin Shelter', email: 'alamin.shelter@gmail.com', accountType: AccountType.shelter, mode: UserMode.consumer, status: AccountStatus.pending, joinedAt: DateTime(2026, 6, 27), isAvailable: true, mealsRescued: 4, onTimePickupRate: 80),
  RegisteredAccount(id: 7, name: 'Bismillah Catering', email: 'bismillah.catering@gmail.com', accountType: AccountType.caterer, mode: UserMode.donor, status: AccountStatus.suspended, joinedAt: DateTime(2026, 3, 8), listingsCreated: 130, kgSaved: 800, fulfillmentRate: 96, rating: 4.6, reviewCount: 12),
  RegisteredAccount(id: 8, name: 'Rahim Uddin', email: 'rahim.uddin@gmail.com', accountType: AccountType.individual, mode: UserMode.consumer, status: AccountStatus.pending, joinedAt: DateTime(2026, 6, 29), isAvailable: false, mealsRescued: 1, onTimePickupRate: 60),
];
