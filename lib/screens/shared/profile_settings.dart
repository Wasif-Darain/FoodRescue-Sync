...
/// Lays out its [children] in a row when the screen is wide enough,
/// otherwise stacks them vertically so fields remain readable on small screens.
class _FieldRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isWide = MediaQuery.of(context).size.width >= _kFieldRowBreakpoint;
    if (isWide) {
      return Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
